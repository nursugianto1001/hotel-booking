<x-app-layout>
    <div class="max-w-7xl mx-auto py-8 px-6 bg-white shadow-md rounded-lg">
        ...
        <!-- Form Tambah Kamar -->
        <form action="{{ route('admin.rooms.store') }}" method="POST" class="mb-6 bg-gray-100 p-4 rounded-md shadow-sm">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input type="text" name="name" placeholder="Nama Kamar" required class="border-gray-300 rounded-md p-2">
                <input type="text" name="type" placeholder="Tipe Kamar" required class="border-gray-300 rounded-md p-2">
            ...
            <table class="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">{{ $room->type }}</td>
